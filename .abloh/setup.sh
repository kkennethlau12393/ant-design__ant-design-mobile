...
# step 1: put the package manager on PATH, for your own lifecycle scripts. From pnpm-lock.yaml, pnpm@10.34.5; chosen over package-lock.json, packageManager declares pnpm@10.34.5
corepack enable

# step 2: dependencies, from your lockfile. From pnpm-lock.yaml, pnpm@10.34.5; chosen over package-lock.json, packageManager declares pnpm@10.34.5
